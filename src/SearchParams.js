...
// const ANIMALS = ["Korok", "Vessel", "Whale Shark", "Dragon"];
const ANIMALS = ["dog", "cat", "bird", "reptile", "dragon"];
...
const SearchParams = () => {
   ...
   // This destructured version is equal to the below
   //    const locationTuple = useState("Charleston, SC");
